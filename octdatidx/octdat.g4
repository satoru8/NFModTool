...
attributesProp : 'attributes' ASSIGN LBRACKET attributeList RBRACKET;
limitProp : 'limit' ASSIGN NUMBER;
activationProp : 'activation' ASSIGN LBRACE activationBody RBRACE;
targetTypeProp : 'targetType' ASSIGN LBRACE targetTypeBody RBRACE;
actionsProp : 'actions' ASSIGN LBRACKET actionList RBRACKET;
ingredientsProp : 'ingredients' ASSIGN LBRACKET ingredientList RBRACKET;
colorsProp : 'ingredientColors' ASSIGN LBRACKET colorList RBRACKET;
prefabProp : 'prefab' ASSIGN LBRACE prefabBody RBRACE;
consumableModifiersProp : 'consumableModifiers' ASSIGN LBRACKET modifierList RBRACKET;
...
temperatureAffectsDecayProp : 'temperatureAffectsDecay' ASSIGN BOOLEAN;
...
staticBuffsProp : 'staticBuffs' ASSIGN LBRACKET staticBuffList RBRACKET;
equipmentCosmeticProp : 'equipmentCosmetic' ASSIGN LBRACE equipmentCosmeticBody RBRACE;
colorSlotsProp : 'colorSlots' ASSIGN LBRACKET colorSlotList RBRACKET;
...
sharedMaterialsProp : 'sharedMaterials' ASSIGN LBRACKET sharedMaterialsList RBRACKET;

attributeList : attribute (COMMA attribute)*;
attribute : ID;

activationBody : 'type' ID 'lengthMinutes' ASSIGN NUMBER 'cooldownMinutes' ASSIGN NUMBER;
targetTypeBody : 'type' ID targetTypeProps?;
targetTypeProps : targetTypeRangeProp | targetTypeAutoEnemiesProp;
...
actionProps : actionStatusEffectNameProp | actionStatusEffectMinutesProp | actionEffectProp | actionSelfProp | actionStatProp | actionDeltaProp | actionMinutesToMaturityProp;
actionStatusEffectNameProp : 'statusEffectName' ASSIGN STRING;
actionStatusEffectMinutesProp : 'statusEffectMinutes' ASSIGN NUMBER;
...
prefabProps : prefabPathProp | prefabNameProp | prefabBehaviorProp | prefabPhysicsProp | sharedMaterialProp;
...
sharedMaterialsList : sharedMaterialProp (COMMA sharedMaterialProp)*;
sharedMaterialProp : LBRACE sharedMaterialBody RBRACE;
sharedMaterialBody : 'type' ID sharedMaterialProps?;
sharedMaterialProps : sharedMaterialNamesProp | sharedMaterialMaterialProp;
sharedMaterialNamesProp : 'names' ASSIGN LBRACKET nameList RBRACKET;
...
modifierProps : modifierNameProp | modifierDeltaProp | modifierStatNameProp | modifierMultiplierProp | modifierGoodProp;
...
staticBuffProps : staticBuffStatNameProp | staticBuffMultiplierProp | staticBuffGoodProp;
...
equipmentCosmeticProps : equipmentCosmeticPrefabProp | equipmentCosmeticMaskMaterialsProp;
equipmentCosmeticPrefabProp : prefabProp;
equipmentCosmeticMaskMaterialsProp : 'maskMaterials' ASSIGN LBRACKET maskMaterialList RBRACKET;
...
colorSlotProps : colorSlotNameProp | colorSlotMaterialsProp | colorSlotReferenceProp;
colorSlotNameProp : 'name' ASSIGN STRING;
colorSlotMaterialsProp : 'materials' ASSIGN LBRACKET materialList RBRACKET;
...
statProps : statNameProp | statFormulaProp | statModifierProp | statMinProp | statMaxProp;
